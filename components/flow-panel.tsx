...
import type { Aspect, ClipVersion, Project, Section, Still, Version } from "@/lib/types";
...
import { PROVIDERS, providerForModel, useProviderKeys, type ProviderId } from "@/lib/providers";
...
import { sectionVersionExists, stillExists } from "@/lib/store-guards";
...
export function ImportedClipPanel({
  section,
  onClose,
}: {
  section: Section;
